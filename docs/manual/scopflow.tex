\chapter{Security-constrained optimal power flow (SCOPFLOW)}
\label{chap:scopflow}
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{0.3\textwidth}|p{0.2\textwidth}|p{0.3\textwidth}|p{0.2\textwidth}|}
    ...
    -netfile & Network file name & string $<$ 4096 characters (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/case9mod_gen3_wind.m}{case9mod\_gen3\_wind.m}) &\\ \hline
    -ctgcfile & Contingency file name & string $<$ 4096 characters (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/case9.cont}{case9.cont}) &\\ \hline
    ...
    -scopflow\_ploadprofile & Real power load profile & string (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/load_P.csv}{load\_P.csv}) &\\ \hline
    -scopflow\_qloadprofile & Reactive power load profile & string (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/load_Q.csv}{load\_Q.csv}) &\\ \hline
    -scopflow\_windgenprofile & Wind generation profile & string (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/scenarios_9bus.csv}{case9/scenarios\_9bus.csv}) &\\ \hline
...
redispatch. One can have AGC control instead of having the generators proportionally share the deficit/excess power by using the option \emph(-opflow\_use\_agc).
