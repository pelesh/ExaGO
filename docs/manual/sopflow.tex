...
\begin{itemize}
    ...
    \item \textbf{Scenario file:} \sopflow only supports reading wind generation scenarios in a CSV format. An example of this format for the 9-bus case is \href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/scenarios_9bus.csv}{here}.
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{0.3\textwidth}|p{0.2\textwidth}|p{0.3\textwidth}|p{0.2\textwidth}|}
    ...
    -windgen & Scenario file name & string 4096 characters (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/10scenarios_9bus.csv}{case9/10scenarios\_9bus.csv}) &\\ \hline
    -ctgcfile & Contingency file name & string (\href{https://github.com/ORNL/ExaGO/tree/develop/datafiles/case9/case9.cont}{case9.cont}) &\\ \hline
